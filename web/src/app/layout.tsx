...
export const metadata: Metadata = {
  ...
  description:
    "საუკეთესო სანადირო და სათევზაო აღჭურვილობა,  ხარისხი, სანდოობა, ფასი. Best hunting and fishing equipment in Georgia",
  keywords: [
    "სანადირო",
    "სათევზაო",
    "აღჭურვილობა",
  ...
  openGraph: {
    ...
    title: "MyHunter - სანადირო და სათევზაო აღჭურვილობის მაღაზია საქართველოში",
    description:
      "საუკეთესო სანადირო და სათევზაო აღჭურვილობა! ხარისხი, სანდოობა, ფასი",
    images: [
      {
        url: "/logo.png",
        width: 1200,
